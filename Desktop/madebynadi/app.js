  ...
  if (payload === 'yes') {
    ...
    response = { "attachment": {
                  ...
                  "payload": {
                   "template_type": "generic",
                    "elements": [{
                      "title": "welcome to my mady by nadi page",
    ...
    response = {
      ...
      "payload":{
        ...
        "elements":[
           {
            "title":"sample photo?",
            "image_url":"https://scontent.fmdl2-2.fna.fbcdn.net/v/t1.0-9/94097412_140998864131912_3890126796825296896_n.jpg?_nc_cat=102&_nc_sid=8bfeb9&_nc_ohc=pIm7YX_QMCIAX8REW7X&_nc_ht=scontent.fmdl2-2.fna&oh=ffaaef19863eccc64c21aac08a18f47d&oe=5ECAB58B",
